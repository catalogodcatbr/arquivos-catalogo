...
```
cd existing_repo
git remote add origin https://gitlab.sgd.nuvem.gov.br/cat-logo-team/arquivos-catalogo-de-bases.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.sgd.nuvem.gov.br/cat-logo-team/arquivos-catalogo-de-bases/-/settings/integrations)
